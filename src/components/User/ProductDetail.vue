<template>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-2" style="background-color: #eaf0fc;">
            ...
            <li class="breadcrumb-item">
                <a href="/laptop" class="text-primary">Laptop</a>
            </li>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="d-flex gap-2 flex-wrap mt-3 justify-content-center">
                    <img v-for="(image, index) in thumbnails" :key="index" :src="image"
                        class="img-thumbnail border border-2" :class="{ 'border-dark': index === currentIndex }"
                        style="width: 100px; height: 100px; object-fit: cover; cursor: pointer"
                        @click="changeImage(index)" :alt="`Ảnh sản phẩm ${index + 1}`" />
                </div>
                ...
                <div class="card p-3 mb-4 mt-5">
                    ...
                    <div class="d-flex justify-content-between small py-1 border-bottom"
                        v-for="(value, label) in specs.cpu" :key="label">
                        <span>{{ label }}</span><span>{{ value }}</span>
                    </div>

                    <h6 class="mt-4 mb-2">Đồ họa</h6>
                    <div class="d-flex justify-content-between small py-1 border-bottom"
                        v-for="(value, label) in specs.gpu" :key="label">
                        <span>{{ label }}</span><span>{{ value }}</span>
                    </div>
                    ...
                    <div v-if="showMore">
                        ...
                        <div class="d-flex justify-content-between small py-1 border-bottom"
                            v-for="(value, label) in specs.other" :key="label">
                            <span>{{ label }}</span><span>{{ value }}</span>
                        </div>
                    </div>
            ...
            <div class="bg-light p-4 rounded-4">
                <div class="row g-4">
                    ...
                    <div class="col-lg-2 d-flex flex-column gap-1 mx-auto">
                        <img src="https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:format(webp):quality(75)/MSI_Thin_15_B12_UCX_18_61d8527eba.jpg"
                            class="img-fluid rounded" alt="Ảnh 1">
                        <img src="https://cdn2.fptshop.com.vn/unsafe/750x0/filters:format(webp):quality(75)/msi_thin_a15_b7u_61070ff9c3.png"
