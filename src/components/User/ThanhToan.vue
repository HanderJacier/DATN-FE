...
import { taoHoaDon, kiemTraPhien } from '../../api';
...
export default {
    ...
    methods: {
        ...
        async submitOrder() {
            ...
            try {
                // Kiểm tra phiên đăng nhập trước khi thanh toán
...
Cảm ơn bạn đã mua hàng! 🎉`);
        ...
        loadUserInfo() {
            ...
            if (user) {
                this.receiverName = user.hoTen || user.name || '';
                this.phone = user.soDienThoai || user.phone || '';
            }
        }
    },
